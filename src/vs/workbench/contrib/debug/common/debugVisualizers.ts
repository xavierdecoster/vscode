...
interface VisualizerTreeHandle {
	getTreeItem(element: number | IDebugVisualizationContext): Promise<IDebugVisualizationTreeItem | undefined>;
	getChildren(element: number | IDebugVisualizationContext): Promise<IDebugVisualizationTreeItem[]>;
	editItem?(item: number, value: string): void;
}
