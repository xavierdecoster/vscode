...
declare module 'vscode' {
	...
	export interface DebugVisualizationTree<T extends DebugTreeItem = DebugTreeItem> {
		 ...
		 */
		getTreeItem(element: T | DebugVisualizationContext): TreeItem | undefined | Thenable<TreeItem | undefined>;
		/**
		 * Gets children for the tree item or the best context item.
		 */
		getChildren(element: T | DebugVisualizationContext): ProviderResult<T[]>;
		/**
		 * Handles the user editing an item.
		 */
		editItem?(item: T, value: string): void;
	}
